...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['jumlah']; ?>">
   ...
   <div class="cart-total">
      <p>Jumlah Total : <span>$<?php echo $grand_total; ?>/-</span></p>
      <div class="flex">
         <a href="shop.php" class="option-btn">Lanjutkan Belanja</a>
         <a href="checkout.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Lanjutkan ke checkout</a>
      </div>
   </div>
